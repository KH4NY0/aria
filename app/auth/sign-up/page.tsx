...
const SignUp = async () => {
    ...
    <div className="mt-10 max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white border border-[#121212] dark:bg-black" >
        <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">Let's get you started</h2>
        ...
        <form className="my-8" action={registerUser}>
            <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
                <div className="flex flex-col">
                    ...
                    <Input id="firstName" type="text" placeholder="khanyo" name="firstname" required />
                </div>
                <div className="flex flex-col">
                    <Label htmlFor="lastname" className="mb-2">Last Name</Label>
                    <Input id="lastName" type="text" placeholder="radebe" name="lastname" required />
                </div>
            </div>
            <Label htmlFor="email">Email Address</Label>
            <Input id="email" type="email" placeholder="example@gmail.com" name="email" required className="mb-3" />

            <Label htmlFor="password">Password</Label>
            <Input id="password" type="password" placeholder="enter a secure password" name="password" required className="mb-5" />
            ...
            dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]">Sign up &rarr;
            </button>
